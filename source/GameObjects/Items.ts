  ...
  export class Items extends Phaser.GameObjects.Sprite {
    ...
    constructor(scene: GameCity, itemObj: any) {
      ...
      this.itemObj.scale != undefined
        ...
        : this.setScale(1);
      this.itemObj.alpha != undefined
        ? this.setAlpha(this.itemObj.alpha)
        : this.setAlpha(1);
      if (this.itemObj.conversationStatus != undefined)
        this.setConversationStatus(this.itemObj.conversationStatus);
        ...
        if (this.itemObj.interactiveArea != undefined) {
          this.setInteractive(
            new Phaser.Geom.Rectangle(
              this.itemObj.interactiveArea.x,
              itemObj.interactiveArea.y,
              this.itemObj.interactiveArea.w,
              itemObj.interactiveArea.h
            ),
